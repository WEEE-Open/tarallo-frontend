...
Features.list.set('type', new Set(['location', 'case', 'motherboard', 'cpu', 'graphics-card', 'ram', 'hdd', 'odd', 'psu', 'audio-card', 'ethernet-card', 'monitor', 'mouse', 'keyboard', 'network-switch', 'network-hub', 'modem-router', 'fdd', 'ports-bracket', 'other-card', 'heatsink', 'fan', 'fan-controller', 'modem-card', 'scsi-card', 'wifi-card', 'external-psu', 'zip-drive', 'printer', 'scanner', 'inventoried-object', 'adapter', 'usbhub']));
...
Features.list.set('cpu-socket', new Set(['other', 'other-slot', 'other-socket', 'other-dip', 'g1', 'g2', 'socket7', 'm', 'p', 'am1', 'am2', 'am2plus', 'am3', 'am3plus', 'am4', 'fm1', 'fm2', 'fm2plus', 'g34', 'c32', 'g3', 'slot1', 'socket370', 'socket462a', 'socket423', 'socket478', 'socket479', 'socket603', 'socket754', 'socket940', 'socket939', 'lga775', 'lga771', 'lga1366', 'lga1156', 'lga1248', 'lga1567', 'lga1155', 'lga2011', 'lga1150', 'lga1151', 'lga3647', 'lga2066']));
...
Features.list.set('psu-connector-cpu', new Set(['none', '4pin', '8pin', 'proprietary']));
