...
Features.list.set('type', new Set(['location', 'case', 'motherboard', 'cpu', 'graphics-card', 'ram', 'hdd', 'odd', 'psu', 'audio-card', 'network-card', 'monitor', 'mouse', 'keyboard', 'switch', 'hub', 'modem-router', 'fdd', 'ports-bracket', 'other-card', 'heatsink', 'fan', 'fan-controller', 'modem-card']));
...
Features.list.set('color', new Set(['black', 'white', 'green', 'yellow', 'red', 'blue', 'grey', 'darkgrey', 'lightgrey', 'pink', 'transparent', 'brown', 'orange', 'violet', 'sip-brown', 'lightblue', 'yellowed', 'transparent-dark']));
...
Features.list.set('ram-form-factor', new Set(['simm', 'dimm', 'sodimm', 'minidimm', 'microdimm']));
