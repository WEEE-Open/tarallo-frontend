...
Features.list.set('psu-socket', new Set(['other', 'at', 'atx-old', 'atx12v', 'atx12v-extended', 'atx12v-4pin', 'atx12v-8pin']));
...
Features.list.set('os-serial-number', null);
Features.list.set('os-serial-version', null);
...
Features.list.set('restrictions', new Set(['loan', 'in-use', 'bought', 'training']));
// END GENERATED CODE
