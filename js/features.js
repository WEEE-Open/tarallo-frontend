...
Features.list.set('hdd-odd-form-factor', new Set(['5.25', '3.5', '2.5', '2.5slim', 'm2']));
Features.list.set('ide-ports-n', null);
Features.list.set('odd-type', new Set(['cd-r', 'cd-rw', 'dvd-r', 'dvd-rw', 'bd-r', 'bd-rw']));
Features.list.set('pcie-power', new Set(['4pin', '6pin', '8pin']));
Features.list.set('pcie-sockets-n', null);
Features.list.set('pci-sockets-n', null);
Features.list.set('power-connector', new Set(['other', 'other-barrell', '']));
...
Features.list.set('psu-socket', new Set(['other', 'at', 'atx', 'atx-p4', 'atx-p4-extended', 'atx-p4-4pin', 'atx-p4-8pin', 'atx-p4-8pin']));
